...
class Job
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Alert::class, mappedBy: 'job')]
    ...
    public function getUpworkId(): ?string
    {
        return $this->upworkId;
    }

    public function setUpworkId(string $upworkId): static
    {
